...
export const developmentError = (err: any, req: Request, res: Response, next: NextFunction): void => {
...
export const productionError = async (err: any, req: Request, res: Response, next: NextFunction): Promise<void> => {
  const status = err.status || 500;
